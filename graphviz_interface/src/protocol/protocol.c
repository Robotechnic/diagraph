...
size_t EdgeLabelInfo_size(const void *s) {
    return string_size(((EdgeLabelInfo *)s)->to) + TYPST_INT_SIZE + string_size(((EdgeLabelInfo *)s)->label) +
           1 + 1 + string_size(((EdgeLabelInfo *)s)->xlabel) + 1 + 1 +
           string_size(((EdgeLabelInfo *)s)->headlabel) + 1 + 1 +
           string_size(((EdgeLabelInfo *)s)->taillabel) + 1 + 1 + TYPST_INT_SIZE +
...
size_t NodeLabelInfo_size(const void *s) {
    return string_size(((NodeLabelInfo *)s)->name) + string_size(((NodeLabelInfo *)s)->label) + 1 + 1 +
           string_size(((NodeLabelInfo *)s)->xlabel) + 1 + 1 + TYPST_INT_SIZE +
...
size_t ClusterLabelInfo_size(const void *s) {
    return string_size(((ClusterLabelInfo *)s)->name) + string_size(((ClusterLabelInfo *)s)->label) + 1 + 1 +
